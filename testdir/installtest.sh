...
wget -O /etc/X11/xorg.conf https://git.nytpu.com/forks/PocketDesk/plain/xorg.conf

# Keyboard
wget -O /home/chip/.Xmodmap https://git.nytpu.com/forks/PocketDesk/plain/.Xmodmap
wget -O /home/chip/.xinitrc https://git.nytpu.com/forks/PocketDesk/plain/.xinitrc
...
# Wallpaper
wget -O /home/chip/.pocket-home/PocketDESK_wall.png https://git.nytpu.com/forks/PocketDesk/plain/PocketDESK_wall.png
